...
class GridviewDelegate extends FairDelegate {
  ...
  Widget _itemBuilder(context, index) {
    return FairWidget(
      name:'assets/bundle/lib_best_flutter_ui_template_gridview_item_template.fair.json',
      path:'assets/bundle/lib_best_flutter_ui_template_gridview_item_template.fair.json',
      data: {
